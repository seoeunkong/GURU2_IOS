//
//  CalendarRecordShowerViewController.swift
//  GURU2Project
//
...
class CalendarRecordShowerViewController:UIViewController{
    ...
    @IBAction func doSave(_ sender: Any) {
        let path = "pets/\(self.petcode!)/shower"
...
extension CalendarRecordShowerViewController:UITextViewDelegate{
