//
//  ClickCommentPost.swift
//  GURU2Project
//
//  Created by 공서은 on 2022/02/02.
//
...
class ClickCommentPost:UIViewController, UITableViewDataSource, UITableViewDelegate{
   ...
   //글쓴이 사진 업로드
    func imageUpload(_ url:String){
        if url != "" {
            ...
            self.image.image = UIImage(named: "no-image-icon.png")
        }
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "MyCommentCell", for: indexPath) as? MyCommentCell else {
